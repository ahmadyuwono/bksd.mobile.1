...
class PageCopyright extends StatefulWidget {
  ...
  @override
  _PageCopyrightState createState() => _PageCopyrightState();
}

class _PageCopyrightState extends State<PageCopyright> {
                        ...
                        (index) => Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text("Copyright ©2021 by Owner\n"),
                                  Text("All rights reservec\n"),
                                  Text("Version " + regulationModel!.version),
                                  Text("Last updated " +
